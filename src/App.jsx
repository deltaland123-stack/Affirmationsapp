...
export default function SayAndItBecomes() {
  ...
  const FALLBACK_AFFIRMATIONS = [
    "Today, I am confident, calm, capable and grounded. I am steady in who I am, and I trust myself a little more with each passing day. I feel a quiet strength settle into my body, my breathing slows, and my mind becomes clear and unhurried. I meet what is difficult as a chance to grow rather than proof of what I lack, because I know capability is built through experience and practice, not handed to me in advance. When something feels uncertain, I slow down, steady my shoulders, and choose my response instead of reacting on impulse. I picture myself moving through this day with an open mind and an even pace. Today I take one honest, meaningful step toward the life I want, and I let that action speak louder than any doubt. I am releasing who I used to be, accepting that I cannot see the whole path, and moving forward anyway. I am becoming the person I have been reaching toward, a little more real each day. Today, I am.",
    "Today, I am strong, stable, positive and self-assured. I trust my own judgment, and I carry a calm confidence that does not need to be loud. I feel grounded through my feet, relaxed in my chest, and quietly hopeful about what this day can hold. I no longer measure myself against an older version of me; I notice how far I have come and keep going. Challenges are information, not verdicts, and every time I face one I grow a little more capable. When pressure rises, I breathe, name what I am feeling, and take the next small step with care. I see myself handling today with patience and a steady hand. Today I take one clear action that matters, and I let it be enough. I am loosening my grip on old fear, making room for uncertainty, and trusting that I can meet whatever comes. I am growing into the person I choose to be, through real experience, one deliberate choice at a time. Today, I am.",
    "Today, I am capable, resilient, happy and at ease with myself. I feel settled in my body and clear in my thinking, and a gentle steadiness runs underneath everything I do. I am allowed to be a beginner at the things I care about, and I know skill grows through practice rather than permission. When doubt shows up, I acknowledge it without letting it steer, and I bring my attention back to the step in front of me. I picture myself moving through this day grounded and unrushed, meeting people and problems with an open, curious mind. Today I take one meaningful action toward what I want, and I trust that consistency matters more than intensity. I am setting down the weight of the past, accepting that I cannot control everything, and choosing to move forward with courage that is quiet but real. I am becoming steadier, kinder and more capable with every experience I create. Today, I am.",
    "Today, I am grounded, confident, positive and steady. I know my own worth, and I meet myself with patience rather than pressure. I feel calm spread through my body, my thoughts slow down, and I sense a warm, hopeful energy about the day ahead. I treat setbacks as part of learning, not a signal to stop, and I remind myself that I become more capable each time I try. When things feel hard, I steady my breath, soften my shoulders, and choose one useful thing to do next. I see myself carrying this quiet strength into every room I enter today. Today I take a single honest step toward the person I am becoming, and I let that be enough. I am releasing my hold on what is behind me, making peace with not knowing exactly how things will unfold, and trusting myself to adapt. I am living my way into a stronger, calmer, more grounded version of myself. Today, I am.",
  ];
